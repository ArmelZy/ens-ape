...
class CourseResourceIT {
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course().title(DEFAULT_TITLE).content(DEFAULT_CONTENT);
        return course;
    }
    ...
    public static Course createUpdatedEntity(EntityManager em) {
        Course course = new Course().title(UPDATED_TITLE).content(UPDATED_CONTENT);
        return course;
    }
    ...
    void putNewCourse() throws Exception {
        ...
        updatedCourse.title(UPDATED_TITLE).content(UPDATED_CONTENT);
    ...
    void fullUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.title(UPDATED_TITLE).content(UPDATED_CONTENT);
