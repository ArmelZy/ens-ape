...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CORRECTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_CORRECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CORRECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CORRECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CORRECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CORRECTION actions', async () => {
      const expectedActions = [
        {
